...
class LoadFile(object):
    ...
    def load_document(self, input, language=None, stoplist=None,
        ...
        if self.normalization == 'stemming':
            ...
            #for i, sentence in enumerate(self.sentences): #codetild: removed
                #self.sentences[i].stems = [w.lower() for w in sentence.words] #codetild:removed        
            pass #*1
    ...
    def candidate_filtering(self,
        ...
        for k in list(self.candidates):
            ...
            # words = [u.lower() for u in v.surface_forms[0]] #codetild: removed
            words = v.surface_forms[0] #codetild: added
